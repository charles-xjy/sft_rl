...
def main():
    ...
    p.add_argument("--predictions", action="append", default=None, metavar="LABEL=PATH",
                   help="模型预测 JSONL（05_baseline.py 风格 {image,question,prediction}）；"
                        "可多次传入做多模型并排对比，每次写成 标签=路径。例如：\n"
